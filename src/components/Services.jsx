        ...
        >
          {services.map((service, index) => (
            <motion.div key={index} variants={itemVariants} className="group">
              <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 h-full flex flex-col transition-all duration-300 hover:bg-white/10 hover:border-green-400/50 hover:-translate-y-2">
                ...
                {/* ✅ Botón que navega a la página interna del servicio */}
                <Link to={service.link} className="w-full">
                  <Button className="w-full bg-transparent border border-white/20 hover:bg-[#0B4F3A] hover:border-[#0B4F3A] text-white font-semibold py-6 rounded-xl transition-all duration-300">
